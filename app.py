...
def pageRender(args):
    ...
    navMenu = ""
    # We are creating a dynamic menu field here
    for menu in args:
        urlLink = menu['url']
        label = menu['label']
        navMenu += f"<a class='nav-link fw-bold py-1 px-0' href='{urlLink}'>{label}</a>"
...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  <header class="mb-auto">
    <div>
      ...
      <nav class="nav nav-masthead justify-content-center float-md-end">"""+navMenu+"""
